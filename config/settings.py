...
MODEL_GEMINI = os.environ.get("MODEL") # Specifies the Google Gemini model to be used by the ADK agent.
APP_NAME_FOR_ADK = "greeting_app" # A unique name for your application within ADK, used for session management.
USER_ID = "test" # A default user ID. In a real application, this would be dynamic (e.g., from a login system).
